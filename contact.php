			...
			<div class="row">
				...
				<div class="col-md-6 animate-box">
					...
					<form action="contact.inc.php" method="post" >
						...
						<div class="form-group">
							<button type="submit" class="btn btn-primary btn-sm btn-block" name="contact-submit">Send Message</button>
						</div>
				...
				<div class="col-md-5 col-md-push-1 animate-box">
					...
					<div class="fh5co-contact-info">
						...
						<ul>
							<li class="phone"><a href="tel://+919880819910">+91 9880819910</a></li>
